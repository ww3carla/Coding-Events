...
public class MySecurityAuthentication implements Authentication {
    ...
    public static MySecurityAuthentication authenticated(MySecurityUser mySecurityUser) {
        return new MySecurityAuthentication(mySecurityUser.getAuthorities(), mySecurityUser.getUsername(), mySecurityUser, null);
    }
